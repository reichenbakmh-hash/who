...
const INSTA_POSTS = [
  {
    ...
    img:"assets/img/insta/post_fenetre_pluie.jpg",
  ...
  },
  {
    ...
    img:"assets/img/insta/post_fenetre_nuit.jpg",
  ...
  },
  {
    ...
    img:"assets/img/insta/post_miroir.jpg",
...
const INTRO_PHOTO_IMG = "assets/img/intro/salon.jpg";

const INSTA_STORY_DESC = "story archivée — photo floue d'une fenêtre, une silhouette dessus. Pas la sienne.";
const INSTA_STORY_IMG = "assets/img/insta/story_fenetre.jpg";
...
const PHOTOS = [
  { desc:"nous deux, l'été dernier", meta:"", img:"assets/img/photos/nous_deux_ete.jpg" },
  { desc:"Milo, collier rouge", meta:"disparu le 12 mars", img:"assets/img/photos/milo.jpg" },
  { desc:"silhouette floue près du portail", meta:"01:58 — la veille de sa mort", img:"assets/img/photos/silhouette_portail.jpg" },
  { desc:"reflet, salle de bain", meta:"2 mars — une ombre dans le couloir, derrière elle. Ce n'est probablement rien.", img:"assets/img/photos/reflet_sdb.jpg" }
];
...
const PREUVES = {
  ...
  photoImg:"assets/img/preuves/homme_veste.jpg",
...
const DOORBELL_EVENTS = [
  { tier:1, time:"02:47", desc:"Mouvement détecté. Un chat, probablement. On distingue à peine une forme basse qui traverse l'allée.", img:"assets/img/portier/tier1.jpg" },
  { tier:2, time:"03:10", desc:"Mouvement détecté. Une silhouette reste immobile près du portail pendant plus de quatre minutes, sans avancer.", img:"assets/img/portier/tier2.jpg" },
  { tier:3, time:"03:58", desc:"Mouvement détecté. La silhouette fixe directement la caméra. Elle ne bouge pas quand le flash infrarouge s'allume.", img:"assets/img/portier/tier3.jpg" },
  { tier:4, time:"04:12", desc:"Mouvement détecté à l'intérieur. Pas à la porte : dans le salon, filmé depuis un angle qui ne correspond à aucune caméra installée chez moi.", img:"assets/img/portier/tier4.jpg" }
];
...
const DAY_CONTENT = {
  2:{
    ...
    photo:{ desc:"empreintes de pas devant l'entrée", meta:"jour 2 — je n'ai pas vérifié le sens dans lequel elles allaient", img:"assets/img/photos/empreintes.jpg" }
  },
  3:{
    antoineMsgs:[
    ...
    photo:{ desc:"la serrure de ma propre porte, rayée de l'intérieur", meta:"jour 3 — comme si quelqu'un l'avait forcée depuis chez moi", img:"assets/img/photos/serrure.jpg" }
  },
  4:{
    antoineMsgs:[
...
const CORPSE_DISCOVERY = {
  ...
  photo:{ desc:"coupure d'article — corps retrouvé près du parc", meta:"la veste décrite est identique à celle qu'Antoine portait dans presque toutes ses stories. Identique à la mienne aussi, achetée le même jour que la sienne, au même vide-dressing.", img:"assets/img/photos/article_corps.jpg" }
};
...
/* ---------- Révélation finale : dernier visuel plein écran après le monologue ---------- */
const FINAL_REVEAL = {
  img:"assets/img/ending/porte_entrouverte.jpg",
  line:"Elle n'a jamais quitté cette maison.",
  title:"FIN"
};
