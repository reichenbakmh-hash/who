...
const FINAL_MONOLOGUE = [
  {
    lines:[
      ...
      "La porte est grande ouverte. Il n'y a personne. Juste le couloir vide, la lumière du palier qui clignote, et un courant d'air froid qui me remonte la nuque.",
      "Je devrais avoir peur. Je devrais crier, courir, appeler quelqu'un.",
      "Mais je reste assise, à regarder mes mains trembler. Ce n'est plus de la peur. C'est autre chose — une mémoire qui remonte avant que le cerveau ait eu le temps de la retenir."
    ],
    pauses:[2600, 3200, 2400, 3600],
    breathe:2400
  },
  {
    lines:[
      ...
      "Et puis Lily qui arrête de rire. Qui recule d'un pas.",
      "Qui dit non. Doucement. Presque en s'excusant de refuser.",
      "Ma main sur son épaule. L'autre dans ses cheveux. Son corps qui se raidit sous mes doigts.",
      "« T'es sérieuse ? »",
      "Sa voix a craqué sur le mot sérieuse. Je m'en souviens encore, exactement comme ça.",
      "Je n'ai pas répondu. Je n'ai pas arrêté non plus."
    ],
    clsList:[null,null,null,null,'quote',null,null],
    pauses:[2800, 2000, 2600, 3000, 2600, 2400, 3200],
    breathe:2200
  },
  {
    lines:[
      "Je me souviens de ses doigts autour de mes poignets — pas pour me repousser, pour ne pas tomber. Elle s'est débattue, assez longtemps pour que je comprenne qu'elle ne voulait pas.",
      "J'ai continué quand même.",
      "Je ne sais toujours pas pourquoi. Si je voulais lui faire mal, ou juste qu'elle me regarde enfin comme je la regardais, moi, depuis des années.",
      "Elle a pleuré sans bruit. Pas de sanglots — juste des larmes qui coulaient, comme si elle avait déjà accepté ce qui était en train de se passer.",
      "« Pourquoi ? »",
      "Un seul mot, soufflé plus que dit. Je n'avais pas de réponse. Je n'en ai toujours pas."
    ],
    clsList:[null,null,null,null,'quote',null],
    pauses:[3200, 2200, 3000, 3000, 2600, 3400],
    breathe:2600
  },
  {
    lines:[
      "Elle s'est relevée. A rajusté son t-shirt. Essuyé ses larmes du dos de la main.",
      "Elle m'a regardée sans colère — juste une fatigue immense, celle de quelqu'un qui vient de comprendre que la personne qu'elle aimait le plus venait de la briser.",
      "« On n'en parle pas. Ça n'a jamais eu lieu. »",
      "Elle est montée sur le toit. Je l'ai suivie — je ne sais même pas pourquoi. Pour m'excuser ? Pour la retenir ? Je ne sais plus.",
      "Elle était au bord, le vent dans les cheveux, à regarder le vide en souriant. Pas un sourire heureux. Un sourire fini.",
      "Je me suis approchée. J'ai tendu la main.",
      "Elle s'est retournée. M'a regardée une dernière fois — sans larmes, sans colère cette fois. Juste une tristesse qui semblait avoir toujours été là, que je n'avais simplement jamais vue.",
      "« Je t'aimais. Et tu as tout gâché. »",
      "Un pas en arrière.",
      "Je n'ai pas crié. Je n'ai pas tendu la main assez vite. J'ai juste regardé ses doigts s'ouvrir, lâcher prise, accepter."
    ],
    clsList:[null,null,'quote',null,null,null,null,'quote',null,null],
    pauses:[2400, 3400, 3000, 3200, 3400, 2200, 3600, 3200, 2000, 3800],
    breathe:3000
  },
  {
    lines:[
      "Je ne l'ai pas poussée. Ça, je peux encore me le dire.",
      "Mais je ne l'ai pas retenue non plus. Et au fond, c'est pareil. C'est peut-être pire."
    ],
    pauses:[3000, 3600],
    breathe:2600
  },
  {
    lines:[
      "Je suis rentrée chez moi avec son téléphone. J'ai écrit des messages, des stories — je vais mal, j'ai envie d'en finir, pardonnez-moi.",
      "J'ai ouvert sa fenêtre. Renversé une chaise. Laissé ses chaussures près du bord.",
      "J'ai tout maquillé, avec un calme qui aurait dû m'inquiéter — comme si j'avais déjà répété cette scène quelque part, dans un coin de moi que je refusais de regarder.",
      "Peut-être que je savais depuis longtemps qu'elle finirait par tomber, par ma faute. Peut-être que je l'ai tuée bien avant ce soir-là — la première fois que j'ai posé mes doigts sur sa nuque sans lui demander, la première fois qu'elle a dit arrête et que je ne l'ai pas écoutée."
    ],
    pauses:[3000, 2800, 3400, 4200],
    breathe:2800
  },
  {
    lines:[
      "Le téléphone vibre encore, contre le sol. Je le ramasse. L'écran est fendu, mais le message est lisible.",
      "« Tu as cherché. Maintenant regarde. »",
      "Je regarde mes mains. La porte ouverte. Le vide du couloir.",
      "Et je comprends, enfin.",
      "Le compte n'a jamais été connecté sur un autre appareil. Il n'y a jamais eu personne d'autre. C'était moi. Depuis le début.",
      "Moi qui envoyais les messages. Moi qui prenais les photos. Moi qui grattais à ma propre porte, la nuit, sans m'en souvenir le matin.",
      "Moi qui me punissais, à ma façon, pour ne pas avoir à écrire la seule phrase vraie :",
      "« Je l'ai tuée. Pas par accident. Pas par colère. Juste parce qu'elle ne voulait pas de moi. »"
    ],
    clsList:[null,'quote',null,null,null,null,null,'quote'],
    pauses:[2800, 3200, 2600, 2200, 3400, 3200, 2600, 4200],
    breathe:3200,
    reveal:true
  },
  {
    lines:[
      "Je me relève. Je ferme la porte.",
      "Dans le reflet de la fenêtre, je croise mon visage, et je lui dis — comme elle me l'a dit ce soir-là :",
      "« On n'en parle pas. Ça n'a jamais eu lieu. »",
      "Mais ça a eu lieu.",
      "Et je le sais.",
      "Et toi aussi, maintenant."
    ],
    clsList:[null,null,'quote',null,null,null],
    pauses:[2800, 3200, 3400, 2400, 2200, 3800],
    breathe:1800
  }
];
